...
本重构版本基于《流溪河模型》论著和相关学术文献开发，参考了 Java 版源码的设计思路，但未直接基于任何源代码进行移植。我们根据公开的模型原理文档，独立实现了一套符合流溪河模型理论框架的 Python 版本。

### 重构初衷

1. **现代化开发**：将模型重构为 Python，便于学术研究者快速上手和二次开发
...
| 对比项 | 原版 (Java) | 本重构版 (Python) |
|--------|-------------|------------------|
| 开发语言 | Java | Python 3.9+ |
| 代码结构 | 面向对象 | 面向对象 |
| 依赖环境 | JDK | NumPy, Pandas |
